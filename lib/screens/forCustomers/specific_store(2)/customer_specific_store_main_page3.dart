...
class CustomerSpecificStoreMainPage3 extends StatefulWidget {
  final String token;
  final String email;
  ...
  final String design;
  const CustomerSpecificStoreMainPage3(
      this.token,
      this.email,
      ...
      {super.key});
  @override
  State<CustomerSpecificStoreMainPage3> createState() =>
      _CustomerSpecificStoreMainPage3State();
}

class _CustomerSpecificStoreMainPage3State
    extends State<CustomerSpecificStoreMainPage3> with WidgetsBindingObserver{
          ...
          Positioned.fill(
            child: ClipPath(
              ...
              child: Container(
                width: double.infinity,
                height: double.infinity,
                color: Color(int.parse(clippingColor.replaceAll("Color(", "").replaceAll(")", "")),
                )
              ),
            ),
          ),
