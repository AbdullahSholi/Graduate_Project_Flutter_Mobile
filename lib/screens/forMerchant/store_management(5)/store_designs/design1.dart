                    ...
                    return Container(
                      ...
                      Visibility(
                        ...
                        child: Column(
                          children: [
                            SizedBox(
                              height: spaceAboveComponent, // Adjust or remove this if needed
                            ),
                            Container(
                              margin: EdgeInsets.fromLTRB(10, 0, 10, 0),
                              width: double.infinity,
                                ...
                                return Container(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                      ...
                                      childAspectRatio: 0.77, // Customize the aspect ratio (width/height) of each tile
                                          ...
                                          Stack(
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.only(
                                                    topRight: Radius.circular(_selectedOptionsVal == "Smooth" ? smoothDesignBorderRadius : solidDesignBorderRadius),
                                                    topLeft: Radius.circular(_selectedOptionsVal == "Smooth" ? smoothDesignBorderRadius : solidDesignBorderRadius),
                                                  ),
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: (storeCartsVal[index]["cartPrimaryImage"].toString() == "null" || storeCartsVal[index]["cartPrimaryImage"].toString() == "")
                                                        ? CachedNetworkImage(
                                                      imageUrl: "https://th.bing.com/th/id/R.2cdd64d3370db75b36e9b02259d1832a?rik=w2QxlPJgMEIzXQ&pid=ImgRaw&r=0",
                                                      height: 180,
                                                      ...
                                                      fit: BoxFit.cover,
                                                        ...
                                                        : CachedNetworkImage(
                                                      imageUrl: storeCartsVal[index]["cartPrimaryImage"],
                                                      height: 180,
                                                      placeholder: (context, url) => SimpleCircularProgressBar(
                                                        mergeMode: true,
                                                        animationDuration: 1,
                                              ...
                                              Positioned(
                                                bottom: 0,
                                                left: 0,
                                                child: storeCartsVal[index]["cartDiscount"].toString() == "true"
                                                    ? Container(
                                          ...
                                          Positioned(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.only(
                                                    bottomRight: Radius.circular(_selectedOptionsVal == "Smooth" ? smoothDesignBorderRadius : solidDesignBorderRadius),
                                                    bottomLeft: Radius.circular(_selectedOptionsVal == "Smooth" ? smoothDesignBorderRadius : solidDesignBorderRadius),
                                                  ),
                                                  color: specificStoreProductsColorVal,
                                                ),
                                                child: Column(
    ...
    setState(() {
      showDialog(
          ...
          builder: (context) => AlertDialog(
            backgroundColor: specificStoreCategoriesColorVal,
            title: Text(
              "Category name",
              style: TextStyle(color: Colors.white),
            ),
